  ...
  return (
    <div className={`vaccination ${isMobile ? "" : "row"}`}>
      <div className={isMobile ? "" : "offset-1 col-5"}>
        ...
        {/*                 <h5 className='subtitle'>¿Quiénes deben vacunarse contra la influenza?</h5>
         */}
        ...
        <img
          src="assets/images/influenza.jpeg"
          alt="influeza"
          width="100%"
          className="img-fluid"
        ></img>
      ...
      <div className={isMobile ? "" : "col-5"}>
        <h5 className="pt-2 pb-2 subtitle">¿Dónde vacunarse?</h5>
