      ...
      <Row>
        <Col md={{ span: 8, offset: 2 }} xs={12}>
          <h3 className="font-weight-bold">
            FUNCIONAMIENTO SERVICIOS MUNICIPALES
          </h3>
          ...
          <div className="text-justify textservice pt-2">
            ...
            dispuesto que los siguientes servicio dejen de funcionar de manera
            presencial ({" "}
...
const onlineServices = [
  ...
  {
    link:
      "https://webviews.smartrancagua.com/view/information/directoryView/?_id:n5sAdCgr9hzqLWohz",
