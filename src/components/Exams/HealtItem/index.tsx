        ...
        <Accordion.Collapse eventKey={service.idx}>
          <Card.Body>
            <div className="list-body">
              {service.information && service.information.trim() !== '' ? (
                <p>
                  <button className="btn btn-block btn-outline-link text-left">
                    <FontAwesomeIcon icon={faInfo} className="health-icon" />{' '}
                    {service.information}
                  </button>
                </p>
              ) : (
              ...
              <p>
                <a
                  href={`http://www.google.com/maps/place/${service.contactInformation.address.latitude},${service.contactInformation.address.longitude}`}
                  target="_blank"
                ...
                >
                  ...
                  {service.contactInformation.address.streetNumber
                    ? ` ${service.contactInformation.address.streetNumber}, `
                    : ', '}{' '}
                  {service.contactInformation.address.city}
                </a>
              </p>
              {service.contactInformation && service.contactInformation.phone && (
                <p>
                  <a
                ...
                service.businessHoursSapu.trim() !== '' && (
                  <p>
                    <button className="btn btn-block btn-outline-link text-left">
                      ...
                      />{' '}
                      SAPU {service.businessHoursSapu}
                    </button>
                  </p>
                )}
            </div>
