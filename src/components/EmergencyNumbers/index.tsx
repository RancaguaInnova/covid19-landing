    ...
    <div className="emergency-numbers p-2">
      ...
      <div className="emergency-box  ">
        <p className="text-center">
          ...
          >
            <FontAwesomeIcon icon={faHeadset} className="health-icon" /> Call
            Center <b>800 100 020</b>
          </a>
        </p>
        <p className="text-center">
          <a
            ...
            className="btn btn-block btn-outline-link text-center"
          >
            <FontAwesomeIcon icon={faWhatsapp} className="health-icon" />{' '}
            WhatsApp <b>+56956478170</b>
          </a>
        </p>
        <p className="text-center">
          <a
