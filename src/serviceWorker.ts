...
import { config } from './providers/firebase.js'
...
export function register(config?: Config) {
    ...
    /* if (isPushNotificationSupported()) { */
      Push.Permission.request((granted: any)=> {     
        console.log('on granted!', granted)
        
        Push.FCM().then(function(FCM:any) {
          console.log('FCM!', FCM)
            FCM.getToken().then(function(token:any) {
